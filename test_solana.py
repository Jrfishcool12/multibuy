...
# 4) no route + jupiter-only -> skip (under Auto it would fall back to pump.fun)
se.jupiter_quote = lambda c, amt: None
p3 = se.build_plan(client, cfg(route="jupiter"), kp, 0)
ck("no Jupiter route (jupiter-only) -> skipped", p3.skip_reason and "route" in p3.skip_reason)
